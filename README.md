...
Here we are again given $n$ items but we can now add fractions of items to the items. The problem can be solved by first sorting the items such that $\frac{p_1}{w_$} \geq \frac{p_2}{w_2}\geq ... \geq \frac{p_n}{w_n}$
