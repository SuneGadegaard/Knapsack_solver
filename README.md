...
Given is $n$ items. Each item $i$ has a profit $p_i$ and a weight $w_i$. The task is to select a subset $S\subseteq { 1,...,n \\}$ of the items, such that $\sum_{i\in S}w_i\leq W$ and such that $\sum_{i\in S}p_i\geq \sum_{i\in P}p_i$ for all $P\subseteq\{1,...,n\}$.
